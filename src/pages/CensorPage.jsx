    ...
    <Box id="Censor">
      <Box className="Censor__box">
        <Box className="Censor__info">
          ...
          <Button className="Censor__btn" leftIcon={<AiOutlineFileSearch fontSize={'24px'} color="white" />}>
            Xem chi tiết
          </Button>
        </Box>
        <Box className="Censor__img">
          ...
          <Box className="Censor__btn2">
            <Button
              ...
              leftIcon={
                <AiFillCheckCircle color="white" fontSize={'20px'} fontWeight="700" onClick={'console.log()'} />
              }
            >
              Đồng ý
            </Button>
