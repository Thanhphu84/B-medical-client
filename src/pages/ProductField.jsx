                    ...
                    <Box className="box__field">
                      <Box>
                        <FormLabel htmlFor="ttm">
                          <b className="input__title">Tên thương mại</b> <span style={{ color: 'red' }}>*</span>
                        </FormLabel>
                        <Input
                          className="input__field"
                          size="sm"
                    ...
                    <Box className="box__field">
                      <Box>
                        <FormLabel htmlFor="pl">
                          <b className="input__title">Phân loại TTB theo độ rủi ro </b>
                          <span style={{ color: 'red' }}>*</span>
                        </FormLabel>
                        <Input
                          className="input__field"
                ...
                <HStack w="100%">
                  ...
                  <FormControl width="50%">
                    <Box className="box__field">
                      <Box>
                        <FormLabel htmlFor="hsx">
                          <b className="input__title">Hãng chủ sở hữu</b> <span style={{ color: 'red' }}>*</span>
                        </FormLabel>
                        <Input
                          className="input__field"
                          size="sm"
                  ...
                  <FormControl width="50%">
                    <Box className="box__field">
                      <Box>
                        <FormLabel htmlFor="nsx">
                          <b className="input__title">Năm sản xuất</b> <span style={{ color: 'red' }}>*</span>
                        </FormLabel>
                        <Input
                          className="input__field"
                          size="sm"
